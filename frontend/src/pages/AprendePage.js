  ...
  return (
    ...
    <Card className='box' style={{ width: '18rem' }}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href='https://bitcoin.org/en/'>Go official</Button>
      </Card.Body>
    </Card>
    ...
    <Card className='box' style={{ width: '18rem' }}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href='https://ethereum.org/en/'>Go official</Button>
      </Card.Body>
    </Card>
    ...
    <Card className='box' style={{ width: '18rem' }}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href='https://kadena.io/'>Go official</Button>
      </Card.Body>
    </Card>
    ...
    <Card className='box' style={{ width: '18rem' }}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href='https://tether.to/en/'>Go official</Button>
      </Card.Body>
    </Card>
    ...
    <Card className='box' style={{ width: '18rem' }}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href='https://cardano.org/'>Go official</Button>
      </Card.Body>
    </Card>
    ...
    <Card className='box' style={{ width: '18rem' }}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href='https://solana.com/'>Go official</Button>
      </Card.Body>
    </Card>
    </section>
  );
